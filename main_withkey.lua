...
local Window = Rayfield:CreateWindow({
    ...
    Discord = {
       ...
       Invite = "Kb4CBD9ZbN", -- The Discord invite code, do not include discord.gg/. E.g. discord.gg/ ABCD would be ABCD
...
KeySettings = {
    ...
    Note = "Получи ключ в нашем Discord https://discord.gg/Kb4CBD9ZbN ",
    FileName = "WonderHubKey",
    SaveKey = true,
    GrabKeyFromSite = false,
    Key = {"50308021", "54724524"}
